...
use GalerieBundle\Entity\Photo;
use GalerieBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $photos = $em->getRepository('GalerieBundle:Photo')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($photo);
        $editForm = $this->createForm(new PhotoType(), $photo);
